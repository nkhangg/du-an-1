 ...
 * @author HP
 */
public class OrderView1 extends javax.swing.JFrame {
...
//        openStatusBox();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrderView1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OrderView1().setVisible(true);
            }
        });
    }
